...
public class FXMLController {
    ...
    void doAttoriSimili(ActionEvent event) {
    	...
    	txtResult.clear();
    	model.getVicini(boxAttore.getValue());
    	txtResult.appendText("Attori simili a:"+ boxAttore.getValue()+"\n");
    	txtResult.appendText(model.getConnectedActor(boxAttore.getValue()).toString());
    ...
    void doCreaGrafo(ActionEvent event) {
    	...
    	boxAttore.getItems().addAll(model.getAttoriGrafo());
